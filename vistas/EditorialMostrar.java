 ...
 * @author Victor Oliva
 */
public class EditorialMostrar extends javax.swing.JInternalFrame {

    JTable tb;
    
    public EditorialMostrar() {
        initComponents();
        DAO4 d1= new DAO4();
        ...
        try
        {
            while (rs.next())
            {
                dtm.addRow(new Object []{rs.getString("cod_edi"), rs.getString("nombre_edi")});
            }
        }
        catch(Exception ex)
        {
