 ...
 * @author Victor Oliva
 */
public class MPMostrar extends javax.swing.JInternalFrame {
    ...
    public MPMostrar() {
        ...
        try
        {
            while (rs.next())
            {
                dtm.addRow(new Object []{rs.getString("cod_pago"), rs.getString("nombre")});
            }
        }
        catch(Exception ex)
        {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Mostrar Métodos de Pago");
