 ...
 * @author Victor Oliva
 */
public class EstadoMostrar extends javax.swing.JInternalFrame {
    ...
    public EstadoMostrar() {
        ...
        dtm.setColumnIdentifiers(new Object[] {"ID","Descripción"});
        ...
        try
        {
            while (rs.next())
            {
                dtm.addRow(new Object []{rs.getString("id"), rs.getString("descripcion")});
            }
        }
        catch(Exception ex)
        {
